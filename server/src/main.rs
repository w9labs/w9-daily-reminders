...
async fn root() -> impl IntoResponse {
    Html(r#"<!DOCTYPE html><html><head><title>W9 Daily Reminders</title></head><body style="background:#160c13;color:#fce126;font-family:monospace;text-align:center;padding:3rem"><h1>W9 DAILY REMINDERS</h1><p>Server running. WASM client building in CI.</p></body></html>"#)
}
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::info!("W9 Reminders: google={}, mail={}", if google_id.is_empty() { "NOT SET" } else { "***" }, mail_api);
